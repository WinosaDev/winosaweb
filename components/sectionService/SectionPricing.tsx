            ...
            {services.map((service, i) => (
              <FadeUp key={service._id} delay={i * 0.2}>
                <div className="group relative h-full">
                  ...
                  <div className="relative rounded-[28px] p-10 bg-white shadow-[0_12px_30px_rgba(0,0,0,0.15)] transition-all duration-500 group-hover:-translate-y-2 group-hover:shadow-[0_20px_50px_rgba(0,0,0,0.25)] flex flex-col h-full">
