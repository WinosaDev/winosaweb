...
export default function SectionMobileFeatures({ data }: { data?: any }) {
  ...
  // 🔥 DEFAULT FALLBACK (multilingual)
  const defaultFeatures: FeatureItem[] = [
    {
      title: t("mobileFeaturesSection", "f1Title"),
      desc: t("mobileFeaturesSection", "f1Desc"),
    },
    {
      title: t("mobileFeaturesSection", "f2Title"),
      desc: t("mobileFeaturesSection", "f2Desc"),
    },
    {
      title: t("mobileFeaturesSection", "f3Title"),
      desc: t("mobileFeaturesSection", "f3Desc"),
    },
    {
      title: t("mobileFeaturesSection", "f4Title"),
      desc: t("mobileFeaturesSection", "f4Desc"),
    },
    {
      title: t("mobileFeaturesSection", "f5Title"),
      desc: t("mobileFeaturesSection", "f5Desc"),
    },
    {
      title: t("mobileFeaturesSection", "f6Title"),
      desc: t("mobileFeaturesSection", "f6Desc"),
    },
  ];

  // ✅ PRIORITY: API DATA FROM ADMIN
        ...
        <FadeUp>
          <div className="mb-20 max-w-2xl">
            <h2 className="text-3xl font-bold mb-4">
              {data?.mobileFeatureTitle ||
                t("mobileFeaturesSection", "title")}
            </h2>

            <p className="text-black/70">
              {data?.mobileFeatureSubtitle ||
                t("mobileFeaturesSection", "subtitle")}
            </p>
          </div>
        </FadeUp>
