    ...
    <footer className="bg-[#efede9] text-black px-12 pt-16 pb-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="space-y-4">
          ...
          <a href="/company" className="block hover:underline">Company</a>
        ...
        <div className="space-y-5">
          <div className="flex items-center gap-3">
            <img src="/logo.png" alt="Winosa" className="h-14" />
          ...
          <div className="flex gap-6 mt-4 items-center">
            ...
            >
              <svg viewBox="0 0 24 24"
                className="w-8 h-8 scale-[1.45] translate-y-[3.3px]"
                fill="white">
            ...
            >
              <svg viewBox="0 0 24 24"
                className="w-8 h-8 scale-[1.05] translate-x-[1.5px]"
                fill="white">
            ...
            >
              <svg
                viewBox="0 0 24 24"
                className="w-8 h-8 scale-[1.15] translate-x-[1px]"
                fill="white"
              >
